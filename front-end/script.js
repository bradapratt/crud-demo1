...
myForm.onsubmit = (event) => {
  ...
  // Send this employee to POST https://crud-demo1.herokuapp.com/employees
  axios
    .post("https://crud-demo1.herokuapp.com/employees", {
      fName,
      lName,
      email,
      role,
...
function getEmployees() {
  axios.get("https://crud-demo1.herokuapp.com/employees").then((res) => {
